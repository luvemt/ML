-The code consists of 2 modules; classifiers.py and datapreprocess.py. I used a second time series dataset from UCI, EEG Eye State.
-To run the code, type: python classifiers.py <dataset_path>
